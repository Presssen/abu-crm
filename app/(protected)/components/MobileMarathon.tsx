...
export default function MobileMarathon({
    ...
    return (
        ...
        >
            ...
            {/* Header Content */}
            <div className="px-5 pt-4 pb-2 bg-white border-b border-gray-100 shrink-0">
                ...
                <div className="flex items-center text-gray-500 text-sm mt-1">
                    ...
                    {lead.contact_role && (
                        <span className="ml-2 text-[10px] bg-gray-100 px-1.5 py-0.5 rounded text-gray-400 font-bold uppercase truncate max-w-[120px]">
                            {lead.contact_role}
                        </span>
                    )}
                </div>
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <button
                        onClick={onLogCall}
                        className="flex flex-col items-center justify-center p-4 bg-gray-900 text-white rounded-2xl shadow-lg active:scale-95 transition-all"
                    >
                        <Phone size={24} className="mb-2 text-emerald-400" />
                        <span className="text-xs font-bold">Llamar</span>
                    </button>
                    <button
                        onClick={() => onSendEmail(emails[0] || '')}
                        className="flex flex-col items-center justify-center p-4 bg-white border border-gray-200 text-gray-900 rounded-2xl shadow-sm active:scale-95 transition-all"
                    >
                        <Mail size={24} className="mb-2 text-blue-500" />
                ...
                <div className="grid grid-cols-2 gap-4 pb-12">
                    <button
                        ...
                        className="py-4 bg-white border border-gray-200 text-gray-400 rounded-2xl text-sm font-bold active:bg-rose-50 active:text-rose-600 active:border-rose-100 transition-all"
                    >
                        Descartar
                    </button>
                    <button
                        onClick={() => onAction('qualify')}
                        className="py-4 bg-indigo-600 text-white rounded-2xl text-sm font-bold shadow-lg shadow-indigo-100 active:scale-95 transition-all"
                    >
                        Cualificar
                    </button>
                </div>
